...
class TrainSlidingWindowGenerator:
    ...
    def __init__(self, predict_mode, appliance_count, file_name, chunk_size, shuffle, offset, batch_size=1000,
                 crop=100000, skip_rows=0, ram_threshold=5 * 10 ** 5):
    ...
    def load_dataset_database(self):
        if self.total_size == 0:
            self.check_if_chunking()
